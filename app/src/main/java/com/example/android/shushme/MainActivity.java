...
public class MainActivity extends AppCompatActivity implements
    ...
    private static final int PERMISSIONS_PLACE_PICKER = 200;
    ...
    public void onAddPlaceButtonClicked(View view) {
        ...
        try {
            newIntent = builder.build(this);
        } catch (GooglePlayServicesRepairableException e) {
            e.printStackTrace();
        } catch (GooglePlayServicesNotAvailableException e) {
            e.printStackTrace();
        }
        startActivityForResult(newIntent, PERMISSIONS_PLACE_PICKER);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == PERMISSIONS_PLACE_PICKER && resultCode == RESULT_OK) {
            ...
            ctx.put(PlaceContract.PlaceEntry.COLUMN_PLACE_ID, placeId);
            getContentResolver().insert(PlaceContract.PlaceEntry.CONTENT_URI, ctx);
        }
    }
